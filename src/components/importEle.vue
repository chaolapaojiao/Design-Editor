...
import svgEle from "@/components/svgEle";
...
export default {
  components: { myTitle, svgEle },
  inject: ["fabric", "canvas"],
  methods: {
    // 插入文本
    addText() {
    ...
    // 添加文本框
    addTextBox() {
      const textBox = new this.fabric.Textbox("黑暗森林", {
        ...defaultPosition,
      ...
      this.canvas.c.add(textBox);
      this.canvas.c.setActiveObject(textBox);
    },
    //添加正方形
    addRect() {
